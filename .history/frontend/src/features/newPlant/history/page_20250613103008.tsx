...
import { EmployeeHistory } from "@/features/newPlant/history/components/previous-employers";
...
import { useStore } from "@/features/newPlant/history/hooks/useStore";
...
const Provider = ({ readOnly }: ProviderProps) => {
  ...
  const handleSubmit: SubmitHandler<Schema> = (data) => {
    updateFormData(data);
    navigate("/employee/locationFind");
  };
