...
import NutrientLevels from "@/components/NutrientLevels"  // Import your nutrient levels component
...
const Page = () => {
  ...
  return (
    ...
    <Container
      ...
      sx={{
        py: 4,
        bgcolor: 'grey.50',       // lighter background for the entire page
        minHeight: '100vh',       // ensure full height
      }}
    >
      <Grid container spacing={2}>
        {/* Heading in its own card with custom background */}
        <Grid item xs={12}>
          <Paper
            elevation={2}
            sx={{
              p: 2,
              bgcolor: 'grey.100',    // subtle grey background for card
              borderRadius: 2,
            }}
          >
        ...
        <Grid item xs={12} md={6}>
          <Paper
            ...
            sx={{
              p: 2,
              bgcolor: 'grey.100',    // matching card background
              borderRadius: 2,
            }}
          >
