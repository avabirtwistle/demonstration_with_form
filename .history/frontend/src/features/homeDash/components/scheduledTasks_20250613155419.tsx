...
const ScrollableList: React.FC = () => {
  ...
  const categoryList = ['Planting', 'Transferring', 'Harvesting', 'Maintenance', 'Cleaning'];

// Use this in your toggle button group
categoryList.map(cat => (
  <ToggleButton key={cat} value={cat} sx={{ textTransform: 'none' }}>
    {cat}
  </ToggleButton>
));
